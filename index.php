                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <select id="inputState" class="form-control col-md-2 ">
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            aria-label="Text input with checkbox"
                                                            placeholder="Suco Natural Laranja">
                                                        <label for="inputState"></label>
                                                        <select id="inputState" class="form-control col-md-2 ">
                                                            <option selected> 1 </option>
                                                            <option> 2 </option>
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            aria-label="Text input with checkbox"
                                                            placeholder="Suco Natural Abacaxi">
                                                        <label for="inputState"></label>
                                                        <select id="inputState" class="form-control col-md-2 ">
                                                            <option selected> 1 </option>
                                                            <option> 2 </option>
                                            ...
                                            <form>
                                                <div class="form-row">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            aria-label="Text input with checkbox" placeholder="Pudim">
                                                        <label for="inputState"></label>
                                                        <select id="inputState" class="form-control col-md-2 ">
                                                            <option selected> 1 </option>
                                                            <option> 2 </option>
                                        ...
                                        <div class="modal-footer bg-dark text-white">
                                            ...
                                            <button type="button" class="btn btn-warning">Confirmar
                                                Pedido</button>
                                        </div>
                                    </div>
                                </div>
